...
# Build a land polygon from restaurants (convex hull + small buffer). This gives a quick
# If you want to limit generation to a specific polygon, set POLYGON_COORDS below
# Coordinates provided as (lat, lon) pairs by the user; we'll convert to (lon, lat)
POLYGON_COORDS = [
...
out_name = "synthetic_lapaz_orders_limited.csv"
