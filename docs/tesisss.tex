...
se asume que los patrones de comportamiento de consumo son universales y transferibles al contexto de La Paz. 
	...
	Cada escenario se ejecuta con tres semillas aleatorias ($s \in \{2025, 2026, 2027\}$)
	para garantizar la robustez estadística de los resultados; los valores reportados
	corresponden al promedio de las tres réplicas salvo que se indique lo contrario.
	...
	generando en total $4 \times 3 \times 2 = 24$ corridas de simulación.  Los 21 KPIs
	...
	sobre las tres réplicas.  El Click-to-Door (CtD) es la métrica principal de calidad
	...
	\centering
	\small
	\caption{Indicadores de calidad de servicio: promedio de 3 réplicas.}
	\label{tab:res_ctd}
	...
	\midrule
	S1 & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} \\
	S2 & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} \\
	S3 & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} \\
	S4 & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} \\
	\bottomrule
	\end{tabular}
	\end{table}
	...
	\centering
	\small
	\caption{Ready-to-Pickup y CTD Overage: promedio de 3 réplicas.}
	\label{tab:res_rtp}
	...
	\midrule
	S1 & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} \\
	S2 & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} \\
	S3 & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} \\
	S4 & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} \\
	\bottomrule
	\end{tabular}
	\end{table}
	...
	\centering
	\small
	\caption{Indicadores de eficiencia operativa: promedio de 3 réplicas.}
	...
	debe atender más pedidos.  La utilización (\% del turno en conducción) refleja la
	fracción del turno que el courier dedica activamente al transporte, excluyendo tiempos
	de espera.

	En el escenario de alta saturación (S4), la utilización bajo FCFS se acerca
	al 100\%, indicando que los repartidores están permanentemente ocupados.  La política
	RH, al coordinar la asignación, puede redistribuir la carga de trabajo de forma más
	equilibrada.

	\subsection{Distancia y enrutamiento}

	La distancia por pedido refleja la eficiencia geográfica del enrutamiento.
	La formación de agrupamientos bajo RH permite que un solo viaje cubra múltiples
	entregas cercanas, reduciendo la distancia recorrida por cada pedido.  Este efecto
	es más pronunciado conforme aumenta la densidad de órdenes por restaurante.
	...
	\centering
	\small
	\caption{Indicadores de agrupamiento y costos: promedio de 3 réplicas.}
	...
	Click-to-Door en cada escenario, con los datos agregados de las tres réplicas.

	\begin{table}[htbp]
	\centering
	\small
	\caption{Prueba de Mann-Whitney $U$ para Click-to-Door: 3 réplicas agregadas.}
	...
	Con una flota holgada, la mayoría de los pedidos se atienden individualmente y la
	diferencia entre FCFS y RH es pequeña.  La prueba de Mann-Whitney puede ser no
	significativa o mostrar tamaños de efecto negligibles.  Esto es esperable: cuando
	hay suficientes repartidores para cada pedido, la coordinación adicional del RH
	ofrece poca ventaja marginal.

	\paragraph{Régimen de saturación media (S3).}
	La heurística RH comienza a mostrar ventajas significativas al coordinar
	agrupamientos y sincronizar tiempos de pickup.  La reducción del CtD
	se vuelve estadísticamente significativa con tamaño de efecto mediano.

	\paragraph{Régimen de alta saturación (S4).}
	Las diferencias se acentúan.  La formación agresiva de agrupamientos permite
	que un número reducido de repartidores atienda una demanda elevada.  El tamaño
	de efecto es grande, confirmando que la mejora no es un artefacto estadístico
	sino una ganancia operativa sustantiva.
